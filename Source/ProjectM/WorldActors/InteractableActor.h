...
UCLASS()
class PROJECTM_API AInteractableActor : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere) UBoxComponent* TriggerVolume;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere) UStaticMeshComponent* MyStaticMesh;

	virtual void OnPlayerOverlapBegin(AActor* OtherActor);
	virtual void OnPlayerOverlapEnd(AActor* OtherActor);
